...
把 [Memory Vault](/src/everlingo/mem/vault/templates/default/spec/vault_spec.md) 中的 markdown 渲染成可浏览、可搜索的静态网站，让用户方便地回顾自己的语言学习知识库。
...
- [Vault Spec](/src/everlingo/mem/vault/templates/default/spec/vault_spec.md) — vault 目录结构与 frontmatter 规范
