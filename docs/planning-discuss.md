...
- 增加功能 chatbot 可以在用户的要求下，选择发送语音给用户。语音的内容可能是要查的单词发音、要翻译的句子、问题的回复文本朗读。发送语音需要满足以下条件：
  - channel 的 get_metadata() 返回的 supported_sound_media_format 包含 "wav"
  - 用户在聊天上下文，或个性设置中，要求发送语音
