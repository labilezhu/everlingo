...
```json
{
  ...
  "source":   { "kind": "web" | "pdf" | "epub" | "ios_app" | "plain",
                "id": "...", "title": "...", "lang_hint": "en",
                // kind-specific fields
                // web:     { "url": "...", "origin": "...", "title":"..." }
                // pdf:     { "file_path": "...", "page_number": 12, "doc_id": "..." }
                // epub:    { "book_id": "...", "chapter": "...", "cfi": "..." }
                // ios_app: { "bundle_id": "...", "app_name": "..." }
                // plain:   { } },
  "device":   { "platform": "chrome_ext" | "ios_app" | "pdf_reader" | "web" | "cli",
