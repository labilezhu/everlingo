...
- 2026-08-19 | Release 正式版 0.1.2：全仓版本号 0.1.2-rc.3 → 0.1.2（__init__.py / MePage.tsx / ws_master·ws_router app.py / pyproject.toml=0.1.2 / vault_spec×2 / README×2 / user-docs×3 / router-master 部署文档 EVERLINGO_VER）；Chrome 扩展 manifest.json=0.1.2、package.json=0.1.2、package-lock 经 npm install 同步并验证 manifest；VERSION_HISTORY.yaml 删除未发布的 0.1.2-rc.4 条目、0.1.2 → released、插入 0.1.3-rc.1 in-progress；release notes v0.1.2 两份 state → released；发布 tag v0.1.2。
