...
2026-07-22 10:00 | Vault Editor 接入 Milkdown 后修复：① handleFileSelect 先 await read 再 setCurrentPath，避免 WYSIWYG 模式 useEditor 挂载时拿到空 content；② WYSIWYG 模式剥离 frontmatter 仅渲染 body，保存时拼回 fm+body 写回后端；更新 vault-editor.md:55 文档
